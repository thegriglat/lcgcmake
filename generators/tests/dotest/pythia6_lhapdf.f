C#@# 5-26: A total cross section [mb] of a single W production at LHC 
C#@# with various PDF sets used via LHAPDF library

      PROGRAM PYTHIA_LHAPDF

c-------------------------------------------------------------
c
c Before running this test the environment variable 
c LHAPATH=/path/to/PDFsets must be set (see ./dotest)
c
...
C...Random number generation stuff
      ...
      parameter (MINTEST=5,MAXTEST=26) ! was 27
...
01    CONTINUE
      ...
      close(10)
100   format('pythia6_lhapdf',I3,2E15.6)
      END

...
C #@# 3 Mean Pt transeverse momentum
*------------------------------------------------------------------------------
*
...
cc      energy=5500.                  ! c.m.s energy per nucleon pair 
      A=207.                        ! atomic weigth        
...
cc     Tf=0.14                        ! freeze-out temperature in GeV
...
cc      ienglu=0                       ! set type of partonic energy loss
cc      ianglu=0                       ! set angular spectrum of gluon radiation    
cc      T0=1.                          ! initial QGP temparature 
cc      tau0=0.1                       ! proper time of QGP formation 
cc      nf=0                           ! number of active quark flavours in QGP 
                                     
* set input PYTHIA parameters:
      msel=1                      ! QCD-dijet production 
      ptmin=10.
      ckin(3)=dble(ptmin)         ! minimum pt in initial hard scattering, GeV 

// #@# e+ e- --> (Z -> mu+ mu- gammas),
// #@#
// #@# 1: average E(mu+ + mu-) / E(mu+ + mu- + gammas) ratio as given by PHOTOS EXP, multiple photon radiation
// #@# 2: average E(mu+ + mu-) / E(mu+ + mu- + gammas) ratio as given by PHOTOS ALPHA ORDER, single photon emission only

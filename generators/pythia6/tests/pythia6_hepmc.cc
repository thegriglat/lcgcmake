// #@# 3: Total cross section [mb] of jets + Z/gamma* at LHC
// #@# 4: Fraction of events with >=2 charged leptons and >=2 jets
//
// AR: 19.05.2010
...
testi << "pythia6_hepmc  3   " << sigma   << "    " << err_sigma   << " " << std::endl;
testi << "pythia6_hepmc  4   " << fr_2lep_2jet << "          " 

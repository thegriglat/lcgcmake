...
function(GET_PWD pwd)
  if(WIN32)
    ...
    execute_process(COMMAND pwd OUTPUT_VARIABLE p OUTPUT_STRIP_TRAILING_WHITESPACE)
  endif()
...
function(GET_HOST host)
  if(WIN32)
    ...
    execute_process(COMMAND hostname -f OUTPUT_VARIABLE h OUTPUT_STRIP_TRAILING_WHITESPACE)
  endif()
  string(TOLOWER ${h} h)
